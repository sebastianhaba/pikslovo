...
public sealed class GoogleVisionOcrProvider(HttpClient httpClient) : IOcrProvider
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!response.IsSuccessStatusCode)
        {
            ...
            throw new TranslationException(AppStrings.Format(AppStrings.Keys.CloudVisionRejected, (int)response.StatusCode, response.StatusCode, details));
        }
        ...
        {
            throw new TranslationException(AppStrings.Format(AppStrings.Keys.CloudVisionError, annotation.Error.Message));
        }
    ...
    private sealed class VisionError
    {
        ...
        public string Message { get; init; } = AppStrings.Get(AppStrings.Keys.UnknownOcrError);
    }
}
